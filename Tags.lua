...
EC.DefaultRecipeTags={
	enGB = langSplit({
		...
		["Enchant Bracer - Greater Strength"] = "Enchant Bracer - Greater Strength,9 strength bracer,9 str bracer",
		["Enchant Bracer - Greater Stamina"] = "Enchant Bracer - Greater Stamina,9 stamina bracer,9 stam bracer",
